...
With the unified topological entropy weight, adaptive simulations yield \(\delta = 0.0645 \pm 0.0029\) and suppression $1,247 \pm 142\times$ across 30 realizations.
\begin{table}[h]
\centering
...
\midrule
\(\delta\) & 0.0645 & 0.0029 & 0.0587 & 0.0712 \\
Suppression & 1247$\times$ & 142$\times$ & 987$\times$ & 1523$\times$ \\
\bottomrule
\end{tabular}
\end{table}
